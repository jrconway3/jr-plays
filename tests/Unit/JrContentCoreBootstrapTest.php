...
final class JrContentCoreBootstrapTest extends TestCase {
	...
	public function test_shared_meta_is_registered(): void {
		...
		$review_meta = get_registered_meta_keys( 'post', 'review' );

		$this->assertArrayHasKey( 'jrblog_page_video_src', $post_meta );
		$this->assertArrayHasKey( 'associated_games', $post_meta );
		$this->assertArrayHasKey( 'ratings', $review_meta );
	}
}
